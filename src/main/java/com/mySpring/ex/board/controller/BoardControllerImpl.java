...
public String saveBoard(@ModelAttribute("ArticleVO")ArticleVO articleVO,@RequestParam("mode") String mode, @RequestParam("board_idx") int board_idx, HttpServletRequest req, @RequestParam("file") MultipartFile file, RedirectAttributes rttr) throws Exception {
	...
	if (mode.equals("edit")) {
		...
		//articleVO.setContent(sb.toString());
		  ...
		  if(file.getOriginalFilename() != null && file.getOriginalFilename() != "") {
		   ...
		   articleVO.setBoard_thumbImg(File.separator + "imgUpload" + ymdPath + File.separator + "s" + File.separator + "s_" + fileName);
