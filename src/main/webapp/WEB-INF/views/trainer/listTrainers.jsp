...
#pagination .on {font-weight: bold; cursor: default;color:#777;}
                  ...
                  <c:forEach var="trainer" items="${trainersList }" varStatus="trainerNum">
                     <div class="col-lg-4 col-sm-6 mb-4">
                        <div class="portfolio-item">
                           ...
                           </div> <img class="img-fluid" src="${contextPath}/resources/img/trainer/${trainer.trainer_img }" alt="" />
                           </a>
                                 ...
                                 <div class="row justify-content-center">
                                    <div class="col-lg-8">
                                       <div class="modal-body">
                                          ...
                                          src="${contextPath}/resources/img/trainer/${trainer.trainer_img }" alt="" />
                                          <p>${trainer.intro }</p>
   ...
   <div class="text-center">
   <h2 class="section-heading text-uppercase">집 근처 헬스장을 찾아보세요</h2>
   </div>
   <div class="map_wrap">
        ...
        <div class="option">
            <div>
                <form onsubmit="searchPlaces(); return false;">
                    키워드 : <input type="text" value="방배동 헬스장" id="keyword" size="15"> 
   ...
   <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=9a6983b27dfdc174cf87525b6112be37&libraries=services"></script>
   <script>
   // 마커를 담을 배열입니다
   var markers = [];
