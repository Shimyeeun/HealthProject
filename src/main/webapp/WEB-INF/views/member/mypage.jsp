               ...
               <c:forEach var="challenge" items="${challList }">
                  ...
                  <div class="container" style="overflow:visible; margin-bottom:20px; padding:10px">
                     <div class="progress_state" style="padding:10px">
                        ...
                        console.log(ingDay);
                        console.log(idx);
                        ingDay = Math.ceil(ingDay);
                        console.log("ingDay" + ingDay);
                        
                        document.write("<div style='text-align:right; width:100%; padding:0.5rem;'>");
                        document.write("<div class='progress' style='margin-left:auto; text-align:right; width:100%; padding:0; height:2rem'>");
                        document.write("<div div id='progressbar' class='progress-bar progress-bar-striped active' role='progressbar' aria-valuenow='' aria-valuemin='0' aria-valuemax='100' style='color:#000000; width:" + percent + "%'>");
                        document.write("도전한지" + ingDay + "일째");
